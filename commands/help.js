...
exports.run = async (client,interaction) => {
    ...
    const page1 = new MessageEmbed()
        ...
        .addFields(
            {name: '__Support server:__', value: 'Interested in contributing or learning about development? Join our [dev server](https://discord.gg/uvdg2R5PAU)', inline: false},
            {name: '__Command List:__', value: '**Page 1:** Voice Commands\n**Page 2:** Informative Commands\n**Page 3:** Other Commands', inline: false})
